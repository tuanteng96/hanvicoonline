...
import { Page, Sheet } from "framework7-react";
    ...
    render() {
        ...
        return (
            <Sheet
                ...
                opened={isReview} onSheetClosed={() => { this.setState({ isReview: false }) }}
                backdrop
            >
                                    ...
                                    <div className="content-box" key={index}>
                                        ...
                                        <div className="feedback">
                                            <div className="rating">
                                                <input type="radio" name="rating" id="rating-5" value="5" onChange={this.changeRating}/>
                                                <label htmlFor="rating-5" />
                                                <input type="radio" name="rating" id="rating-4" value="4" onChange={this.changeRating}/>
                                                <label htmlFor="rating-4" />
                                                <input type="radio" name="rating" id="rating-3" value="3" onChange={this.changeRating}/>
                                                <label htmlFor="rating-3" />
                                                <input type="radio" name="rating" id="rating-2" value="2" onChange={this.changeRating}/>
                                                <label htmlFor="rating-2" />
                                                <input type="radio" name="rating" id="rating-1" value="1" onChange={this.changeRating}/>
                                        ...
                                        <div className="content-box__text">
                                            <textarea name="RateNote" onChange={this.onChangeRateNote} placeholder="Chia sẻ đánh giá của bạn. Đánh giá của bạn sẽ được giữ dưới chế độ ẩn danh." rows="2"></textarea>
                                        </div>
                                        <div className="content-box__btn">
                                            <button type="button" className="btn-reviews" onClick={() => this.postReviews()}>Gửi đánh giá</button>
                                        </div>
                                    </div>
                                )
                            })
